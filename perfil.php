		...
		<div class="header-wrapper">
			<div class="nav-container">
				<div class="nav">
					<div class="nav-left">
						<ul>
							<li><a href="<?php echo BASE_URL; ?>home.php"><i class="fa fa-home" aria-hidden="true"></i>Início</a></li>
							<?php if ($getFromU->loggedIn() === true) { ?>
								<li><a href="<?php echo BASE_URL; ?>i/notifications"><i class="fa fa-bell" aria-hidden="true"></i>Notificações</a></li>
									...
									<div class="drop-wrap">
										<div class="drop-inner">
											<ul>
												...
												<li><a href="<?php echo BASE_URL; ?>editarPerfil.php">Configurações</a></li>
					...
					<ul>
						...
						<li>
							<a href="<?php echo BASE_URL . $profileData->username; ?>/following">
								<div class="n-head">
									<a href="<?php echo BASE_URL . $profileData->username; ?>/following">Seguindo</a>
								</div>
								<div class="n-bottom">

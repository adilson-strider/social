...
<body>
				...
				<div class="nav">
					...
					<div class="nav-left">
						<ul>
							...
							<li><a href="i/notifications"><i class="fa fa-bell" aria-hidden="true"></i>Notificações</a></li>
							<li id="messagePopup"><i class="fa fa-envelope" aria-hidden="true"></i>Mensagens</li>
						</ul>
					</div><!-- nav left ends-->
								...
								<div class="drop-wrap">
									<div class="drop-inner">
										<ul>
											...
											<li><a href="editarPerfil.php">Configurações</a></li>
											<li><a href="includes/logout.php">Sair</a></li>
										</ul>
									</div>
								</div>
							</li>
							<li><label class="addTweetBtn">Rede social</label></li>
						</ul>
					</div><!-- nav right ends-->
								...
								<div class="tweet-inner">
									...
									<div class="tweet-body">
										<form method="post" enctype="multipart/form-data">
											<textarea class="status" maxlength="141" name="status" placeholder="Escreva alguma coisa aqui..." rows="4" cols="50"></textarea>
											<div class="hash-box">
												<ul>
												</ul>
											</div>
									...
									<div class="tweet-footer">
										...
										<div class="t-fo-right">
											...
											<input type="submit" name="tweet" value="postar" />
											</form>
										</div>
									</div>
								</div>
	...
	Imagem de <a href="https://br.freepik.com/fotos-gratis/close-up-da-mulher-sentada-na-escada-usando-o-aplicativo-de-midia-social-no-celular_2587220.htm#page=4&query=social%20network&position=17&from_view=search&track=sph">Freepik</a>
</body>
